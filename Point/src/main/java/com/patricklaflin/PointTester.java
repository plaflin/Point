...
public class PointTester {
    public static void main(String[] args) {
        ...
        System.out.println("The point is being moved to (4,13)");
        location1.move(4,13);
        System.out.println("The 2D point is now at (" +location1.x+ ", " +location1.y+ ")");
        System.out.println("It is being moved -10 on both the x and y axes");
        ...
        System.out.println("The point is being moved to (10,22,71)");
        location2.move(10,22, 71);
        System.out.println("The 2D point is now at (" +location2.x+ ", " +location2.y+ ", " +location2.z+ ")");
        System.out.println("It is being moved -10 on both the x,y, and z axes");
